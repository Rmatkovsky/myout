...
import normalizrTr from '../../utils/mappers/trophy.mapper';
...
const getChallenge = (post) => {
    if (post.type === 'trophy') {
        return normalizrTr.res.getTrophy(post);
...
const getChallenges = (posts = []) => posts.map(getChallenge);
